...
\begin{sol}
    \begin{itemize}
        ...
        \begin{align}
            ...
            \notag{\color{red}=}&{\color{red}\sum_{n=-\infty}^{\infty}c_n\mathscr{F}\left[e^{-j2\pi(f-\frac{n}{4})t}\right]}\\
            \notag\text{\sout{$=$}}&\text{\sout{$\sum_{n=-\infty}^{\infty}\frac{1-\cos(n\pi)}{(n\pi)^2}\delta(f-\frac{n}{4}).$}}\\
            {\color{red}=}&{\color{red}\sum_{n=-\infty}^{\infty}c_n\delta\left(f-\frac{n}{4}\right)}.
        \end{align}
