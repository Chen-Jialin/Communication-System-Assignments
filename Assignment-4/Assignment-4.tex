...
\begin{sol}
    ...
    \begin{align}
        P_s=\frac{1}{2}A_c^2a^2\langle m_n^2(t)\rangle=200\langle\cos^2(40\pi t)\rangle=100\langle 1+\cos(80\pi t)\rangle=100.
    \end{align}
...
Note that the following two problems are two extension problems based on what you have learned on the class.
